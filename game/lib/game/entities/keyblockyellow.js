...
EntityKeyblockyellow = ig.Entity.extend({
	size: {x: 32, y: 36},
	maxVel: {x: 0, y: 0},
	offset: {x: 0, y: -4},
	...
	activating: false,
	deactivating: false,
	animSheet: new ig.AnimationSheet( 'media/blocks/keyblock.png', 32, 32 ),
	rightFrame: null,
	zIndex: -1,
	setBricks: false,
	
	unlockSound: new ig.Sound( 'media/sounds/yellow-key.*' ),
...
ig.EntityPool.enableFor( EntityKeyblockyellow );
});