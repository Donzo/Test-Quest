<?php
	...
	$contractAddress = '0xc2BC0B330D39F4380946a6bEAf951829B31FF887';
	...
	$amount = Utils::toWei('10', 'ether'); // Adjust the amount as needed
	...
	$increaseFactor = '1.50'; //30% increase
	...
	try{
		...
		if (isset($result->result)) {
			echo 'Transaction successful! Transaction hash: ' . $result->result;
		}
		else{
			print_r($result); // Print the result for debugging if the transaction failed
		}
	}
	catch (Exception $e) {
